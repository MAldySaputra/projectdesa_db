...
<?php
	...
	$sql_tampil = "SELECT * FROM tbl_penduduk WHERE id_penduduk = '$id_penduduk'";
...
<body>
	<center>
		...
		<?php
			$sql_tampil = "select * from tbl_penduduk
	...
	<center>
		...
		<h4>No Surat :
			<?php echo $data['id_penduduk']; ?>/Ket.Domisili/
			<?php echo $tanggal; ?>
		</h4>
	</center>
	...
	<p>Adalah benar-benar warga Desa Pagadungan, Kecamatan Tempuran, Kabupuaten Karawang</P>
