...
class Authentication {
    ...
    public function authenticate($email, $password) {
        $user = mysqli_query($this->db, "SELECT * FROM tbl_pengguna WHERE email = '$email'");
    ...
    private function authorizeUser($userData) {
        ...
        $redirectPath = ($_SESSION['role'] == 'admin') ? '../pages/content/dashboard/dashboard' : '../pages/content/dashboard/dashboard';
