<?php
    ...
    // >>>>>>>>>>>>>>>>>>>>>>>>>>>>>> GET LIST DATA TMU <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
	$QueryGetListUser = mysqli_query($db_connect, "SELECT * FROM tbl_pengguna");
    ...
    if(isset($_POST['save'])){
        ...
        $QueryAddUser = "INSERT INTO tbl_pengguna (nama, role, email, password, jabatan, no_hp, alamat) VALUES ('$NAME', '$ROLE', '$EMAIL', '$PASSWORD', '$JABATAN', '$NOHP', '$ALAMAT')";
