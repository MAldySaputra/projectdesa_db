...
<?php
	...
	$sql_tampil = "SELECT * FROM tbl_pendatang WHERE id_datang = '$id_datang'";
...
<body>
	<center>
		...
		<?php
			$sql_tampil = "select * from tbl_pendatang
	...
	<table>
		<tbody>
			...
			<tr>
				...
				<td>:</td>
				<td>
					<?php echo $data['tanggal_datang']; ?>
				</td>
			</tr>
			<?php } ?>
		</tbody>
	</table>
	<p>Benar-benar Telah datang dan berencana untuk tinggal di Desa Pagadungan, Kecamatan Tempuran, Kabupuaten Karawang</P>
